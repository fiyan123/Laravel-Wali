                        ...
                        <form action="{{ route('jurusan.update', $jurusan->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control  @error('semester') is-invalid @enderror" name="semester">{{ $jurusan->semester }}</textarea>
                                    @error('semester')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="string" class="form-control  @error('jurusan') is-invalid @enderror"
